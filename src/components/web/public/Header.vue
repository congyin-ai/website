            ...
            <template slot="title"><svg
              ...
              >
                <path
                  ...
                  p-id="4075"
                ></path></svg></template>
            <el-menu-item @click.native="changeType('zh')">{{$t('langs.zh')}}</el-menu-item>
            <el-menu-item @click.native="changeType('en')">{{$t('langs.en')}}</el-menu-item></el-submenu>
          </el-menu>
        </div>
      </div>
    </div>
